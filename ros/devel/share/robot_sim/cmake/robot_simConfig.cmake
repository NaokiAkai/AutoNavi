...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/akai/Dropbox/work/AutoNavi/ros/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/akai/Dropbox/work/AutoNavi/ros/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/akai/Dropbox/work/AutoNavi/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'akai <akai@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/akai/Dropbox/work/AutoNavi/ros/src/robot_sim/${idir}'.  Ask the maintainer 'akai <akai@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/akai/Dropbox/work/AutoNavi/ros/devel/lib;/home/akai/Dropbox/work/AutoNavi/ros/devel/lib;/home/akai/Dropbox/Research/cmob_auto/ros/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_sim_dep}_FOUND)
      find_package(${robot_sim_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_sim_dep} REQUIRED ${depend_list})
  endif()
